...
class UnitName(Date, models.Model):
    ...
    name = models.CharField(verbose_name='Наименование АТЕ', max_length=200)

    class Meta:
        verbose_name = 'Наименование АТЕ'
        verbose_name_plural = 'Наименования АТЕ'
...
class Designation(models.Model):
    ...
    class Meta:
        verbose_name = 'Обозначение АТЕ'
        verbose_name_plural = 'Обозначения АТЕ'


class UnitDesignation(Date, models.Model):
    unit = models.ForeignKey(Unit, verbose_name='АТЕ', on_delete=models.CASCADE, related_name='designations')
    designation = models.ForeignKey(Designation, verbose_name='Обозначение', on_delete=models.CASCADE, related_name='names')
